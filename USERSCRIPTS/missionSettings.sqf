...
USECUSTOMLOADOUTS = false;               //use custom loadouts defined in bluforLoadouts.sqf and opforLoadouts.sqf?  (true/false)
...
WAVERESPAWNTIME = 10;                  //delay before a complete wave respawns
RESPAWNWAVEEXTRATIME = 60;              //time after a wave has respawned, that an additional player may respawn alone in
MAXRESPAWNTIME = 300;                  //maximum time a player has to wait under any circumstances (will respawn alone if needed)
